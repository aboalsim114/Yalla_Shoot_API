...
class TeamAdmin(admin.ModelAdmin):
    list_display = ('user', 'team_name', 'sport',
...
class MatchAdmin(admin.ModelAdmin):
    list_display = ('team', 'sport', 'date_time', 'location')
...
class SportActivityAdmin(admin.ModelAdmin):
    list_display = ('player', 'sport', 'duration', 'calories_burned')
    list_filter = ('sport',)
...
class MessageAdmin(admin.ModelAdmin):
    ...
    list_display = ('sender', 'recipient', 'content', 'sent_at')
    list_filter = ('sent_at',)
